...
public class Category_2 extends JFrame {
	...
	public Category_2() {
		...
		categoryPanel.setLayout(new FlowLayout(FlowLayout.CENTER, 50, 50));

		mainPanel.add(categoryPanel);

		// 카테고리 버튼 추가
		categoryPanel.add(icecreamBtn);
		categoryPanel.add(icecakeBtn);
		categoryPanel.add(coffeeBtn);
		categoryPanel.add(beverageBtn);
		categoryPanel.add(dessertBtn);
