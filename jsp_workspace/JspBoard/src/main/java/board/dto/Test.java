...
public class Test {
	...
	public static void main(String[] args) {
		// String에 기본적으로 들어가있는 해시 메서드는 해당 문자열의 값만으로 결과를 충분히 도출해낼 수 있기 때문에 
		// 비밀번호의 해시로 사용하기에는 적합하지 않다
		System.out.println("ABCD".hashCode());
		System.out.println(("abcddsafdsafdasfdsafsdafsdfds"
				+ "fdsafasdfdsffdsfdsffdsfsdffdsdasfsdafas"
				+ "fdsafsdafdsfdsfasfdsffdsfdsfsdfdsfsfdas"
				+ "fdsfdsfdsfdsafsadfdsafsdaffdsfdsfasdfsa").hashCode());
