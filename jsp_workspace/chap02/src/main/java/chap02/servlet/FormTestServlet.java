...
public class FormTestServlet extends HttpServlet{
	...
	// service() : 요청을 구분하지 않고 요청을 받으면 무조건 호출되는 메서드
...
//      System.out.println(req);
      ...
      System.out.println(req.getParameter("user_age"));
      System.out.println(req.getParameter("user_password"));
      System.out.println(req.getParameter("user_color"));
      System.out.println(req.getParameter("my_math"));
